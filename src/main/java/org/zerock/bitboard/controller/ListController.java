...
public class ListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Integer page = getInt(request.getParameter("page"));//파라미터 수집해서 getInt메서드에 입력.
        ...
        List<BoardDTO> dtoList = BoardService.INSTANCE.getlist(pageDTO);//pageDTO던져주면 BoardDTO목록받아온다.
        ...
        //페이지 메이커의 현재 페이지, 페이지 내 출력할 갯수, 데이터의 총 갯수(123이라고 가정)
